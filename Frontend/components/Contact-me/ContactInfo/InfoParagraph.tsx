...
function InfoParagraph() {
	...
	return (
		<div className="overflow-hidden  transition-all ">
			<p className={`text-[14px] w-[90%] md:w-full mx-auto md:mx-0 rounded-xl  mt-2 overflow-hidden transition-all duration-300  ${isOpen ? "max-h-[2000px]" : "max-h-20"} ${isDark ? "text-[#888888]" : "text-[#555555]"}`}>
			...
			<div className="w-full flex items-center justify-center mt-3">
				<button
					className={`px-2 py-1 rounded-md transition-all duration-150 ${isDark ? "bg-blue-600 hover:bg-blue-700" : "bg-blue-400 text-white hover:bg-blue-500"}`}

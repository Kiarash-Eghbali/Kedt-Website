...
function InfoButton() {
    ...
    return (
        <>
            <div className={`flex items-center justify-around w-[80%] md:w-[60%] mt-4`}>
                <Link href={"/contact-me"} className={isDark
                     ? "bg-[#252525] p-2 px-5 rounded-md text-sm md:text-lg hover:bg-blue-600 transition-all duration-150" 

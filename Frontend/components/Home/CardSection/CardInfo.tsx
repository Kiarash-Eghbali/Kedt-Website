		...
		<>
			<section className={`grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 border-b ${isDark ? "border-[#252525]" : "border-gray-400"} mb-5 items-center justify-center`}>
				<Card
					...
					className={isDark ? "border-[#252525] bg-[#252525] text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-150" : "border-gray-300 text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-150"}
                />
				<Card
					...
					className={isDark ? "border-[#252525] bg-[#252525] text-pink-400 hover:bg-pink-400 hover:text-white transition-all duration-150" : "border-gray-300 text-pink-400 hover:bg-pink-400 hover:text-white transition-all duration-150"}
				/>
				<Card
				    ...
				    className={isDark ? "border-[#252525] bg-[#252525] text-green-600 hover:bg-green-600 hover:text-white transition-all duration-150" : `border-gray-300 text-green-600 hover:bg-green-600 hover:text-white transition-all duration-150`}
				/>
				<Card
				    ...
				    className={isDark ? "border-[#252525] bg-[#252525] text-[#888888] hover:bg-[#666666] hover:text-white transition-all duration-150" : "border-gray-300 text-[#666666] hover:bg-[#666666] hover:text-white transition-all duration-150"}
				/>
			</section>
		</>
	);

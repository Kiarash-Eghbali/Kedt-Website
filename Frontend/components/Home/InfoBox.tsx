		...
		<>
			<div className={`flex items-center justify-center flex-col w-[90%] md:w-[80%] mx-auto border-b pb-10 ${isDark ? "border-[#252525]" : "border-gray-400"}`}>
				<div className="flex items-center justify-center flex-col gap-2">
					...
					<h1 className={` text-4xl md:text-6xl pt-7 ${isDark ? "text-gray-300" : "" } font-black ${poppins.className}`}>Kiarash Eghbali</h1>
                    <p className={`font-bold md:text-2xl ${isDark ? "text-blue-400" : "text-gray-600"}`}>طراح و توسعه دهنده وبسایت های مدرن</p>
                    <p className={`text-[11px] md:text-base mt-5 m-1 w-[70%] ${isDark ? "text-blue-100" : "text-gray-500"} text-center`}>من کیارش اقبالی، توسعه‌دهنده فول‌استک ۱۶ ساله از ایرانم. با React، Next.js، TypeScript، Express و Laravel کار می‌کنم و عاشق ساختن چیزهای تمیز و مدرنم.</p>
                    <InfoButton />
				</div>
			</div>
		</>
